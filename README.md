...
I'm a **Full Stack / Mobile Software Developer** with hands-on experience building production-grade web and mobile applications.

My focus areas:
- 🔧 Reliable **backend services** and scalable REST APIs
- 🎨 Modern **frontend interfaces** and admin panels
- 📱 Cross-platform **mobile apps** (React Native + Expo)
- 🗄️ **Database design** and system architecture
- 🚀 End-to-end product delivery — design to deployment

I build software that is technically solid, maintainable, and useful for real users.
...
![Next.js](https://img.shields.io/badge/Next.js-ffffff?style=flat-square&logo=next.js&logoColor=000000)
...
| Domain | Focus Areas |
|---|---|
| **Backend Development** | REST APIs · Authentication · Business Logic · Service Architecture |
| **Frontend Development** | Responsive UI · Admin Panels · Dashboards · Component Systems |
| **Mobile Development** | React Native · Expo · Cross-Platform Builds · API Integration |
| **Database Design** | MySQL · MongoDB · Relational Modeling · Query Optimization |
| **Product Delivery** | Feature Ownership · Debugging · Deployment · Performance Tuning |
